...
public class Laboratories extends javax.swing.JFrame implements Cloneable{
    ...
    private Laboratories(int code){
        this();
    }
    
    public static Laboratories getInstance(){
        if(labs==null){
            labs=new Laboratories(5);
        }
        return labs;
    }
