...
public class Facilities extends javax.swing.JFrame implements Cloneable{

    private static Facilities fa;
    ...
    private Facilities(int code){
        this();
    }
    
    public static Facilities getInstance(){
        if(fa==null){
            fa=new Facilities(3);
        }
        return fa;
